...
def libraryclick():
    ...
    if (radMedia.get() == "Book"):
        ...
        exit_button.pack()
        randbutton = Button(top, text="make a random choice from library", command=randbut)
        randbutton.pack()
    elif (radMedia.get() == "Movie"):
        top = Toplevel()
...
def randbut():
    ...
    if (radMedia.get() == "Book"):
        bookdict = db.search(media.mediatype == "Book")
        randchoice = random.choice(list(bookdict))
        messagebox.showinfo("Random choice", randchoice['mediatitle'])
    elif (radMedia.get() == "Movie"):
        moviedict = db.search(media.mediatype == "Movie")
        randchoice = random.choice(list(moviedict))
        messagebox.showinfo("Random choice", randchoice['mediatitle'])
    elif (radMedia.get() == "Game"):
        gamedict = db.search(media.mediatype == "Game")
        randchoice = random.choice(list(gamedict))
        messagebox.showinfo("Random choice", randchoice['mediatitle'])
